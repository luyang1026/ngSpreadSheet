...
var ReportoneComponent = (function () {
    function ReportoneComponent(dataservice) {
    ...
    return ReportoneComponent;
}());
ReportoneComponent = __decorate([
    core_1.Component({
        templateUrl: './app-reportone.component.html'
    }),
    __metadata("design:paramtypes", [app_data_service_1.DataService])
], ReportoneComponent);
exports.ReportoneComponent = ReportoneComponent;
